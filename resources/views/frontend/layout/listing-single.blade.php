...
<div class="content">
    <div class="container">
        <div class="breadcrumbs-list bl_flat">
            <a href="#">Home</a><a href="#">Properties</a><a href="#">New York</a><span>Property Single
                2</span>
                    ...
                    <div class="fw-carousel lightgallery">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <!-- Loop through the images of the single property -->
                                @foreach ($singleProperty->images as $image)
                                    <div class="swiper-slide hov_zoom">
                                        <img src="{{ asset($image->images) }}" alt="Image not found" />
                                        <a href="{{ asset($image->images) }}" class="box-media-zoom popup-image">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="scroll-content-wrap">
                            ...
                            <div class="ps-facts-wrapper">
                                ...
                                <div class="ps-facts-item">
                                    <h4>Bethroom</h4>
                                    <h5>{{ $singleProperty->bethrooms }}</h5>
                            ...
                            <div class="accordion">
                                ...
                                <a class="toggle" href="#">
                                    Details option 2 <i class="fa-solid fa-caret-down"></i></a>
                                ...
                                <a class="toggle" href="#">
                                    Details option 3 <i class="fa-solid fa-caret-down"></i></a>
                                <div class="accordion-inner">
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Maecenas in pulvinar neque. Nulla finibus
                                        ...
                                        <div class="col-lg-6">
                                            <div class="map-container mapC_vis2">
                                                <div id="singleMap" class="single-map-container fs-wrapper"
                                                    data-latitude="40.7427837" data-longitude="-73.11445617675781"
                                                ...
                                                <input id="pac-input" class="controls fl-wrap controls-mapwn"
                                                    ...
                                                    placeholder="What Nearby? Schools, Gym... " value="" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                                ...
                                                <div class="nerby-list-container">
                                                    <div class="nerby-list">
                                                        ...
                                                        <div class="nerby-list-box">
                                                            <ul>
                                                                <li>
                                                                    <i class="fa-light fa-school"></i>School:
                                                                    <span>1.2km</span>
                                                                </li>
                                                                <li>
                                                                    <i class="fa-light fa-cart-shopping"></i>Shopping
                                                                    Mall: <span>2.2km</span>
                                                                </li>
                                                                <li>
                                                                    <i class="fa-light fa-user-police-tie"></i>Police
                                                                    Station: <span>1.6km</span>
                                                                </li>
                                                                <li>
                                                                    <i class="fa-light fa-truck-medical"></i>Hospital:
                                                                    <span>0.7km</span>
                                                                </li>
                                                                <li>
                                                                    <i class="fa-light fa-teddy-bear"></i>Playschool:
                                                                    <span>1.1km</span>
                                                                </li>
                                                                <li>
                                                                    <i class="fa-light fa-bench-tree"></i>Parks:
                                                                    <span>0.2km</span>
                                                                </li>
                                                            </ul>
                                                            <a href="#" class="commentssubmit commentssubmit_fw"
                                                                style="margin-top: 10px">Get Directions</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="graph-price-counter">
                                            <div class="graph-price-counter-wrap">
                                                <div class="stats animaper">
                                                    <div class="num" data-content="27" data-num="27">
                                                        0
                                                    </div>
                                                    <span class="price-perc"><i
                                                            class="fa-light fa-percent"></i></span>
                                                </div>
                                    ...
                                    <div class="listing-item">
                                        <div class="geodir-category-listing">
                                            <div class="geodir-category-img">
                                                ...
                                                <div class="geodir-category-location">
                                                    <a href="#4" class="map-item"><i
                                                            class="fas fa-map-marker-alt"></i> W
                                                ...
                                                <a href="#" class="geodir_save-btn tolt"
                                                    data-microtip-position="left" data-tooltip="Save"><span><i
                                            ...
                                            <div class="geodir-category-content">
                                                ...
                                                <div class="geodir-category-content-details">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <i class="fa-light fa-chart-area"></i><span>550 ft2</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="geodir-category-footer">
                                                ...
                                                <a href="listing-single.html" class="gid_link"><span>View
                                                        Details</span>
                                    ...
                                    <div class="listing-item">
                                        <div class="geodir-category-listing">
                                            <div class="geodir-category-img">
                                                ...
                                                <div class="geodir-category-location">
                                                    <a href="#4" class="map-item"><i
                                                            class="fas fa-map-marker-alt"></i> 70
                                            ...
                                            <div class="geodir-category-footer">
                                                <a href="agent-single.html" class="gcf-company"><img
                                                        src="{{ asset('frontend/images/announcer.jpg') }}"
                                                        alt="" /><span>By Andy Sposty</span></a>
                                                <a href="listing-single.html" class="gid_link"><span>View
                                                        Details</span>
                                                    <i class="fa-solid fa-caret-right"></i></a>
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="listing-item">
                                        <div class="geodir-category-listing">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html" class="geodir-category-img_item">
                                                    <div class="bg" data-bg="frontend/images/all/properties2.jpg">
                                                    </div>
                                                    <div class="overlay"></div>
                                                </a>
                                                <div class="geodir-category-location">
