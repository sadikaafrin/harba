                            ...
                            <div class="user-dasboard-menu_wrap">
                                ...
                                <div class="user-dasboard-menu faq-nav ">
                                    <ul>
                                        ...
                                        <li><a href="dashboard-editprofile.html" class="act-scrlink">  Edit profile</a></li>
                                    </ul>
                            ...
                            <div class="row">
                                    ...
                                    <div class="dasboard-content-item">
                                        ...
                                        <div class="custom-form">
                                            ...
                                            <div class="cs-intputwrap">
                                                ...
                                                <input type="text"   placeholder="Second Name" value="">
                                            </div>
                                            <!-- listsearch-input-item -->
                                            <!-- listsearch-input-item -->
                                            <div class="cs-intputwrap">
                                            ...
                                            <!-- listsearch-input-item -->
                                            <div class="cs-intputwrap">
                                                <textarea name="comments" id="comments" cols="40" rows="3" placeholder="About Text:"></textarea>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="edit-profile-photo">
                                        ...
                                        <div class="remove_phav tolt" data-microtip-position="left"  data-tooltip="Remove Photo" ><i class="fa-light fa-trash"></i></div>
                                    </div>
                                    <!--dasboard-content-item-->
                                    {{-- <div class="dasboard-content-item">
                                    ...
                                    <form method="POST" action="{{ route('update-user-profile') }}">
                                        ...
                                        <div class="dashboard-content-item">
                                            ...
                                            <div class="custom-form">
                                                ...
                                                <div class="cs-intputwrap">
                                                    <i class="fa-brands fa-facebook-f"></i>
                                                    <input type="text" name="facebook" placeholder="Facebook" value="{{ auth()->user()->userDetail->facebook ?? '' }}">
                                                </div>

                                                <!-- TikTok -->
                                                <div class="cs-intputwrap">
                                                    <i class="fa-brands fa-tiktok"></i>
                                                    <input type="text" name="tiktok" placeholder="TikTok" value="{{ auth()->user()->userDetail->tiktok ?? '' }}">
                                                </div>

                                                <!-- Instagram -->
                                                <div class="cs-intputwrap">
                                                    <i class="fa-brands fa-instagram"></i>
                                                    <input type="text" name="instagram" placeholder="Instagram" value="{{ auth()->user()->userDetail->instagram ?? '' }}">
                                                </div>

                                                <!-- X-Twitter -->
                                                <div class="cs-intputwrap">
                                                    <i class="fa-brands fa-x-twitter"></i>
                                                    <input type="text" name="x_twitter" placeholder="X-Twitter" value="{{ auth()->user()->userDetail->x_twitter ?? '' }}">
                                                </div>

                                                <!-- YouTube -->
                                                <div class="cs-intputwrap">
                                                    <i class="fa-brands fa-youtube"></i>
                                                    <input type="text" name="youtube" placeholder="Youtube" value="{{ auth()->user()->userDetail->youtube ?? '' }}">
                                                </div>
                                            </div>
